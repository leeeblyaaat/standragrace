...
function winAndBtm2() {
    ...
    else if (topQueens[0].performanceScore == topQueens[1].performanceScore && randomNumber(0, 100) < 60 || isPairChallenge && randomNumber(0, 100) < 85) {
        topQueens[0].addToTrackRecord(" WIN");
        topQueens[0].favoritism += 5;
        topQueens[0].ppe += 5;
        topQueens[1].addToTrackRecord(" WIN");
...
function lipSync() {
    ...
    if (thirdqueen && currentCast.length > 5) {
        ...
        if (score1 > 7 && score2 > 7 && randomNumber(0, 100) <= 50 && !doubleShantay && !noDouble && currentCast.length > 5) {
            if (randomNumber(0, 100) >= 95) {
                screen.createImage(bottomQueens[0].image, "tomato");
                screen.createBold(bottomQueens[0].getName() + ", shantay you stay.");
                screen.createImage(bottomQueens[1].image, "red");
...
let naysha = new Queen("Naysha Lopez", 6, 4, 4, 4, 3, 6, 7, "Naysha");
...
let clover = new Queen("Clover Bish", 7, 7, 7, 7, 7, 7, 7, "CloverBish");
let chuchi = new Queen("Drag Chuchi", 7, 7, 7, 7, 7, 7, 7, "DragChuchi");
let hornella = new Queen("Hornella Góngora", 7, 7, 7, 7, 7, 7, 7, "HornellaGongora");
let maria = new Queen("María Edília", 7, 7, 7, 7, 7, 7, 7, "MariaEdilia");
let kellyRoller = new Queen("Kelly Roller", 7, 7, 7, 7, 7, 7, 7, "KellyRoller");
let pakita = new Queen("Pakita", 7, 7, 7, 7, 7, 7, 7, "Pakita");
let pink = new Queen("Pink Chadora", 7, 7, 7, 7, 7, 7, 7, "PinkChadora");
...
let twoQueensRelation1 = [
    "talked about gays and they bond.",
    "agreed that the person who won didn't deserved the win.",
    "are sharing wigs.",
    "are making a fake boomerang on instagram",
    "are sharing samples",
    "kiss eachother.",
...
let twoQueensRelation2 = [
    "shared a flop moments to each other.",
...
let twoQueensRelation3 = [
    ...
    "arguing about debut position in bbhot100"
];
let twoQueensRelation3_2 = [
    "is saying that they have a better track record than",
    "is saying that такая тупая блин клас is",
    "albums were just a cash-grab says",
    "stole a song from",
...
let twoQueensRelation5 = [
    "are talking about who is the homophobic queen of the season.",
...
let threeQueensRelation1 = [
    ...
    "drank a few too many cocktails.",
    "wants to make a collaboration song",
    "are founding boygenius 2.0"
];
...
let threeQueensRelation3 = [
    "get into a heated debate about Grammy.",
...
let fourQueensRelation1 = [
    ...
    "drank a few too many cocktails.",
    "dancing уэнсдэ's dance",
    "making a collabarate album with Jack Antonoff"
];
let fourQueensRelation2 = [
    "are talking a lot and the others think that they are in this together.",
    "shared personal memories to each other.",
    "discuss Lana Del Rey's letter to culture"
];
...
let fourQueensRelation4 = [
    "arguing who is gonna headline Coachella 2024",
    "yelled at eachother",
    "are arguing about who is gonna to win AOTY of the grammy",
    "are arguing about who is gonna to win SOTY of the grammy"
];
